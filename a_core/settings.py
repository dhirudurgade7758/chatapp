...
#     'django.contrib.messages',
#     'django.contrib.staticfiles',
#     'django_cleanup.apps.CleanupConfig',  # Optional for cleaning up unused files
#     'django_htmx',  # Optional for HTMX integration
#     'channels',  
...
# Ensure Daphne is installed and used as the ASGI server